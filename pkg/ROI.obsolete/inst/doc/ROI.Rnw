...
Constructing a linear program is done via the \code{LP()} constructor:

<<>>=
lp <- LP(objective = c(2, 4, 3),
...
the \code{QP()} constructor:

<<>>=
qp <- QP( Q_objective (Q = diag(1, 3), L = c(0, -5, 0)),
...
<<>>=
qcp <- QCP( Q_objective(Q = matrix(c(-33, 6, 0, 6, -22, 11.5, 0, 11.5, -11),
                        byrow = TRUE, ncol = 3),
                        L = c(1, 2, 3)),
